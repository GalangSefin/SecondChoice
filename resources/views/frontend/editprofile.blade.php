        ...
        <div class="profile-form">
            ...
            <form action="{{ route('updateProfile') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone_number" name="phone_number" class="form-control" value="{{ Auth::user()->phone_number }}" placeholder="Masukkan nomor Telepon">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="alamat" name="alamat" class="form-control" value="{{ Auth::user()->alamat }}" placeholder="Masukkan Alamat lengkap">
                </div>
