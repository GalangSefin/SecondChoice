...
<link rel="stylesheet" href="{{ asset('second_choice/css/product-latest.css') }}">
      ...
      <div class="slide">
        <div class="slide-content">
          ...
          <div class="slide-button">
            ...
            <a href="{{ route('tutorial') }}" class="btn-secondary rounded-full hover:bg-red hover:text-white transition-colors duration-300">Cara Jualan</a>
          </div>
        </div>
      </div>
    </div>
